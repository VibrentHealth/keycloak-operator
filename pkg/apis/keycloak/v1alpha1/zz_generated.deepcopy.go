...
func (in *KeycloakAPIRealm) DeepCopyInto(out *KeycloakAPIRealm) {
	*out = *in
	...
	if in.RequiredActions != nil {
		...
		*out = make([]KeycloakAPIRequiredActions, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KeycloakAPIRequiredActions) DeepCopyInto(out *KeycloakAPIRequiredActions) {
	*out = *in
	if in.Config != nil {
		in, out := &in.Config, &out.Config
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KeycloakAPIRequiredActions.
func (in *KeycloakAPIRequiredActions) DeepCopy() *KeycloakAPIRequiredActions {
	if in == nil {
		return nil
	}
	out := new(KeycloakAPIRequiredActions)
	in.DeepCopyInto(out)
	return out
}
